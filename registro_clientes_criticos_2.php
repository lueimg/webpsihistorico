...
$averia_fono = $ob_averia->getAveriaxFono($cnx, $fonoBus);
$averia = $ob_averia->getAverias($cnx, $averia_fono);
	...
	<div class="datos">
		<div class="content_datos">
			...
			<div class="caja_medium">
				...
				<input type="text" value="<?php echo trim($averia["fecha_registro"]);?>" name="h_fecha_registro" disabled>
				<input type="hidden" value="<?php echo trim($averia["fecha_registro"]);?>" name="fecha_registro">
			</div>
			<div class="caja">
				<label>Contrata:</label>
				<input type="text" value="<?php echo trim($averia["eecc_zona"]);?>" name="h_eecc_zona" disabled>
	...
	<div class="datos">
		<div class="content_datos">
			...
			<div class="caja_medium">
				...
				<input type="hidden" value="<?php echo trim($averia["fecha_reporte"]);?>" name="fecha_reporte">
				...
				<input type="hidden" value="<?php echo trim($averia["quiebre"]);?>" name="quiebre">
				...
				<input type="hidden" value="<?php echo trim($averia["total_llamadas_tecnicas"]);?>" name="total_llamadas_tecnicas">
				<input type="hidden" value="<?php echo trim($averia["total_llamadas_seguimiento"]);?>" name="total_llamadas_seguimiento">
			...
			<div class="content_datos">
						<div class="caja_medium">
							...
							<?php
								...
								$ob_horario->getHorarios($cnx,$averia["eecc_zona"],$averia["zonal"]);
							?>
							</div>
