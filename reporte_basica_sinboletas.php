...
header("Content-Disposition: attachment; filename=reporte_basica_sinboletas.xls");
//header("Content-Disposition: attachment; filename=boleta_basica_sinboletas.xls");
header("Expires: 0");
...
ON a.telefono=b.telefono AND a.`ooss`=b.`orden`
WHERE b.`ciudad`='00990' AND b.cod_negocio='01'
AND movimiento NOT IN ('R', 'N') AND b.`contrata`!='SC'
AND a.`telefono` IS NULL";
