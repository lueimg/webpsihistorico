                ...
                $("#frm_criticos").submit(function (event){
                    ...
                    $.ajax({
                        ...
                        success: function(datos) {
                            ...
                            window.parent.jQuery('#dialog-registro-manual').dialog('close');
                            window.parent.$("#filtro_personalizado").click()
    ...
    <body>
        ...
        <div class="registro_clientes">
            <form name="frm_criticos" id="frm_criticos" action="" method="POST">
                ...
                <table>
                    <tr>
                        <td style="text-align: left; width: 150px">Tipo averia</td>
                    ...
                    <tr>
                        <td style="text-align: left">Inscripcion</td>
                        <td style="text-align: left">
                            <input class="border" maxlength="255" value="" id="inscripcion" name="inscripcion" />
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <input class="border" type="text" value="" maxlength="11" name="telefono" id="telefono" />
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <input class="border" type="text" value="" maxlength="255" name="direccion" id="direccion" />
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <input class="border" type="text" value="" maxlength="255" name="cr_nombre" id="cr_nombre" />
                    ...
                    <tr>
                        ...
                        <td style="text-align: left"><input class="border" type="text" value="" maxlength="11" name="eecc" id="eecc" readonly="true" /></td>
                    </tr>
                    <tr>
                        <td style="text-align: left">Lejano</td>
                        <td style="text-align: left">
                            <input class="border" type="text" value="" maxlength="11" name="lejano" id="lejano" readonly="true" />
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left">Microzona</td>
                        <td style="text-align: left">
                            <input class="border" type="text" value="" maxlength="11" name="microzona" id="microzona" readonly="true" />
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">
