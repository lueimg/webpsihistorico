...
class gestionCriticos{
	...
	SELECT * FROM(
		SELECT * FROM(
					...
					IFNULL((select tmp.DATA17 FROM schedulle_sistemas.tmp_gaudi_total tmp where tmp.DATA17=a.codigo_req ),'') 'existe',
	...
	SELECT * FROM(
		SELECT * FROM(
					...
					,IFNULL((SELECT wu_nagendas FROM webpsi_coc.averias_criticos_final WHERE averia=acf.averia),IF(IFNULL(acf.wu_nagendas,'')='',0,acf.wu_nagendas)) wu_nagendas , '0' n_evento 
	...
	SELECT * FROM(
		SELECT * FROM(
					...
					,IFNULL((SELECT wu_nagendas FROM webpsi_coc.averias_criticos_final WHERE averia=tp.codigo_req),IF(IFNULL(tp.wu_nagendas,'')='',0,tp.wu_nagendas)) wu_nagendas , '0' n_evento 
		...
		SELECT * FROM(
			SELECT * FROM(
									...
									'' as 'flag_tecnico',tipo_averia,horas_averia,fecha_registro,ciudad,averia 'codigo_averia',inscripcion,fono1,telefono,mdf,observacion_102,segmento,
													...
													,IFNULL((SELECT wu_nagendas FROM webpsi_coc.averias_criticos_final WHERE averia=vacf.averia),IF(IFNULL(vacf.wu_nagendas,'')='',0,vacf.wu_nagendas)) wu_nagendas , '0' n_evento 
