...
header("Content-Disposition: attachment; filename=averias_criticos_EMPRESAS_historico.xls");
header("Expires: 0");
...
$fecIni = $_REQUEST["fecIni"]." 00:00:01";
$fecFin = $_REQUEST["fecFin"]." 23:59:59";
...
$cad = "SELECT * FROM webpsi_coc.averias_criticos_empresas_historico 
		WHERE fecha_subida BETWEEN '$fecIni' AND '$fecFin'
		ORDER BY 1 ASC ";
