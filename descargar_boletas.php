...
function descargabasica() {

	window.open("basica.php");

}

function descargaspeedy() {

	window.open("speedy.php");

}

function descargacatv() {

	window.open("catv.php");
...
function reporteHistorico() {
	...
	var pag = "reporte_criticos_empresas_excel_averias_historico.php?fecIni="+fecIni+"&fecFin="+fecFin;
...
<div id="div_bus" class="divBusqueda" style="width: 750px" >
	...
	<table class="tablaBusqueda">
		<thead>
			<th colspan='3'>LIQUIDADAS SIN BOLETAS</th>
		</thead>	
	
	<tr class="tr_busqueda">
		<td style="width: 100px">1.-basica  :</td >
		<td style="background-color:white; padding: 5px;" ><a href="#" onclick="descargabasica();">[ Descargar ]</a></td >
	</tr>
	<tr class="tr_busqueda1">
		<td style="width: 100px">2.-speedy :</td >
		<td style="background-color:white; padding: 5px;" ><a href="#" onclick="descargaspeedy();">[ Descargar ]</a></td >
	</tr>
		<tr class="tr_busqueda2">
		<td style="width: 100px">3.-catv :</td >
		<td style="background-color:white; padding: 5px;" ><a href="#" onclick="descargacatv();">[ Descargar ]</a></td >
	</tr>
	<?php
/*
	<tr class="tr_busqueda">
...
<div id="div_bus2" class="divBusqueda" style="width: 750px" >
	...
	<table class="tablaBusqueda">
		<thead>
			<th colspan='3'>Reporte de historico Averias - Segmento EMPRESAS</th>
		</thead>
