...
if (count($arrCatvPen)>0) {
	foreach ($arrCatvPen as $filaCatvPen) {
		...
		<tr>
		<td>CATV</td>
		<td><a href="#" onclick="verDetalle('averia','adsl-pen', '<?php echo $filaCatvPen["averia"]?>');"><?php echo $filaCatvPen["averia"]?></a></td>	
...
<div id="resDetalle" name="resDetalle" class="div_detalle" style="border: 1px solid white; float : right; width : 50%;"></div>
