...
<body>
	...
	<table class="tabla_res_grupal" style="width: 100%;" >
		...
		<tr>
			...
			<th class="th_res_grupal2">Nombre Celula</td>
			<th class="th_res_grupal2">Responsable</td>
		...
		foreach ($arr as $fila) {
		  ...
		  ?>
			<tr  >
				...
				<td class="td_res_grupal2" style="width:120px"><?= ($fila["responsable"])?$fila["responsable"]:"Sin responsable"?></td>
