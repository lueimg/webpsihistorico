...
var TableToolsInit = {
	...
	"sPrintMessage": "",
	"sTitle": "",
	"sSwfPath": "js/ZeroClipboard/ZeroClipboard.swf",
	"iButtonHeight": 30,
	"iButtonWidth": 30,
...
function TableTools ( oInit )
{
	...
	function fnFeatureSaveCSV ()
	{
		...
		clip.setAction( 'save' );
		clip.setFileName( fnGetTitle()+'_'+'.csv' );
	...
	function fnFeatureSaveXLS ()
	{
		...
		var fecha = new Date();
		//var fecha_res = fecha.getDate() + "-" + (fecha.getMonth() +1) + "-" + fecha.getFullYear() + " " + fecha.getHours() + "-" + fecha.getMinutes() + "-" + fecha.getSeconds();
		var fecha_res = fecha.getDate() + "-" + (fecha.getMonth() +1) + "-" + fecha.getFullYear();
		var nButton = document.createElement( 'div' );
		...
		clip.setHandCursor( true );
		clip.setAction( 'save' );
		//clip.setFileName( fnGetTitle()+"_"+fecha_res+'.xls' );
		clip.setFileName( "clientescriticos_"+fecha_res+'.xls' );
